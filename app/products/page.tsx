    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            All <span style={{ opacity: 0.55 }}>23</span>
          </button>
          <button
            type="button"
            style={{
          ...
          >
            Baby <span style={{ opacity: 0.55 }}>5</span>
          </button>
          <button
            type="button"
            style={{
          ...
          >
            Kids <span style={{ opacity: 0.55 }}>6</span>
          </button>
          <button
            type="button"
            style={{
          ...
          >
            Women's <span style={{ opacity: 0.55 }}>6</span>
          </button>
          <button
            type="button"
            style={{
          ...
          >
            Men's <span style={{ opacity: 0.55 }}>6</span>
          </button>
        </div>
      </section>
